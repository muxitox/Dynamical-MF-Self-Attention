import numpy as np
import time
from bifurcation_diagrams_out_inf_parallel import runner, plotter
import argparse
...
parser.add_argument("--num_betas", help="Specify the number of beta values",
                    type=int, default=3)
parser.add_argument("--beta_att", help="Specify the beta for the attention",
                    type=float)
